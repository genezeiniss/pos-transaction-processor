...
import com.genezeiniss.pos_transaction_processor.domain.payment_method_modifiers.MastercardModifier;
...
public class MastercardTrxProcessor extends TransactionProcessor {
    ...
    public MastercardTrxProcessor(MastercardModifier properties) {
        super(properties);
    }
